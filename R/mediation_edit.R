...
#'
#' @export
mediation_edit <- function(x, ...) {
  UseMethod("mediation_edit")
}


#' @rdname mediation_edit
...
#' @export
mediation_edit.brmsfit <- function(x, treatment, mediator, mediator_pc, prob = .9, typical = "median", ...) {
